...
image:https://img.shields.io/docker/pulls/keydrive/keydrive[Docker Pulls,link="https://hub.docker.com/r/keydrive/keydrive"]
...
services:
  keydrive:
    image: keydrive/keydrive:{latest-release}
