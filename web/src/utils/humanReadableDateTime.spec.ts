...
describe('humanReadableDateTime', () => {
  it('formats the date and time', () => {
    expect(humanReadableDateTime('2021-03-26T23:32:42.139992387Z')).toBe(
      '26 March 2021 at 23:32',
    );
  });
  ...
  it('uses today when the date is today', () => {
    ...
    expect(humanReadableDateTime(`${dateString}T09:33:42.139992387Z`)).toBe(
      'Today at 09:33',
    );
  });
  ...
  it('uses yesterday when the date is yesterday', () => {
    ...
    expect(humanReadableDateTime(`${dateString}T14:24:42.139992387Z`)).toBe(
      'Yesterday at 14:24',
    );
  });
});
